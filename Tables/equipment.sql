...
(
    ...
    weapon_category NVARCHAR (64) NULL,
    -- 'Simple', 'Martial'
    armor_category NVARCHAR (64) NULL,
    -- 'Light', 'Medium', 'Heavy', 'Shield'
    tool_category NVARCHAR (128) NULL,
    -- 'Artisan\'s Tools', 'Musical Instrument', etc.
    ...
    range_normal INT NULL,
    -- Normal range in feet
    range_long INT NULL,
    -- Long range in feet
    throw_range_normal INT NULL,
    -- Throwing normal range
    throw_range_long INT NULL,
    -- Throwing long range
