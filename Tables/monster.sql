...
(
    ...
    -- References Monster Type
    sub_monster_type_id BIGINT NULL,
    -- References Monster Type if is_subtype = 1
    -- Speed fields
    speed_walk INT NULL,
...
CREATE TABLE monster_armor_class
(
...
CREATE TABLE monster_proficiency
(
...
CREATE TABLE monster_damage_data
(
    ...
    -- Comma separated list
    condition_immunities NVARCHAR (MAX) NULL,
    -- Comma separated list
    created_at DATETIME DEFAULT GETDATE (),
    updated_at DATETIME DEFAULT GETDATE (),
    deleted BIT NOT NULL DEFAULT 0
